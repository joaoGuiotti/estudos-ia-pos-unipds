...
export class UserView extends View {
    ...
    attachUserSelectListener() {
        this.#userSelect.addEventListener('change', (event) => {
            ...
            const userId = target.value ? Number(target.value) : null;
    ...
    attachPurchaseClickHandlers() {
        ...
        const purchaseElements = document.querySelectorAll<HTMLElement>('.past-purchase');
        ...
        purchaseElements.forEach(purchaseElement => {
            ...
            purchaseElement.onclick = () => {
                ...
                const element = purchaseElement.closest('.col-md-6') as HTMLElement;
