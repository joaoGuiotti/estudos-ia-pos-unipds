export class AIService {
    ...
    /** Known Gemini Nano defaults — used as fallback when params() is unavailable (web page context). */
    ...
    async getParams() {
        try {
            ...
            return { ...AIService.DEFAULT_PARAMS, ...params };
        } catch {
            console.info('[LanguageModel] params() unavailable — using defaults');
            return AIService.DEFAULT_PARAMS;
        }
    }
